...
if RAILWAY_HOSTNAME:
    # Hapus 'https://' dari awal dan tambahkan ke daftar
...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic', # Untuk Whitenoise di development
...
MIDDLEWARE = [
    ...
    # Whitenoise harus berada tepat di bawah SecurityMiddleware
