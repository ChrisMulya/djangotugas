"""
Django settings for alatmusik project.
...
SECRET_KEY = 'django-insecure-9le%s#=#ruos!+p*+p!ykg^!wfj#zsrvcf+8oj8f%#npmrq$*g'
...
if 'DATABASE_URL' in os.environ:
    DATABASES = {
        'default': dj_database_url.config(conn_max_age=600, ssl_require=False) # ssl_require=False untuk Railway
    }
else:
    DATABASES = {
        'default': {
